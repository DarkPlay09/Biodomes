...
public class EditModel : PageModel
{
    ...
    public EditModel(IBiomeRepository biomeRepository)
    {
    ...
    public IActionResult OnGet(string slug)
    {
        ...
        Input.Name = biome.Name;
        Input.Temperature = biome.Temperature;
        Input.AbsoluteHumidity = biome.AbsoluteHumidity;
    ...
    public IActionResult OnPost(string slug)
    {
        ...
        var existingBiome = _biomeRepository.GetBySlug(slug);
        if (existingBiome is null)
            return NotFound();

        if (existingBiome.Creator.Id != currentUserId)
            return Forbid();
        ...
        try
        {
            ...
            _biomeRepository.Update(slug, biome);
        }
